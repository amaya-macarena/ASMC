# -*- coding: utf-8 -*-
"""
Python 3.7 implementation of the Adaptive Sequential Monte Carlo method presented in Amaya et al. (2021).
...
This implementation (ASMC-DREAM) uses the code presented by Laloy et al. (2018a) for GAN-based probabilistic inversion using 
